This is the manual of the module _syn_, introduced in the [syn.py](https://github.com/radiomicsgroup/SpinFlowSim/blob/main/code/syn.py) file.
```
Help on module syn:
...
FUNCTIONS
    ComputeAllPaths(C, idxin, idxout)
    ...
    ComputeFlow(radmat, resmat, nodein, nodeout, qin, solver='numerical')
    ...
    ComputeResHagPois(piperad, pipelen, mu)
    ...
    ComputeResModHagPois(piperad, pipelen, mu)
    ...
    SegmentIn2Out(posin, posout, v, dt)
    ...
    Traj2Signal(spinpos, gradx, grady, gradz, deltatime)
    ...
    getGradPGSE(bval, Gdur, Gsep, Gdir, dt, Nsample=None)
