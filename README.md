...
* The folder [**networks**](https://github.com/radiomicsgroup/SpinFlowSim/tree/main/networks) contains the resolved 2D vascular networks generated for our [Medical Image Analysis paper](https://doi.org/10.1016/j.media.2025.103531). These can be used to synthesise vascular dMRI signals for any acquisition protocol of interest (find [here](https://github.com/radiomicsgroup/SpinFlowSim/tree/main/networks/README.md) how). Addiontally networks are contained in the folder [**networks3D**](https://github.com/radiomicsgroup/SpinFlowSim/tree/main/networks3D). This set of 3D networks has been generated by perturbing the original 2D networks, as iillustrated in our second paper (Voronova et al, Magnetic Resonance in Medicine 2026, [doi: 10.1002/mrm.70318](https://doi.org/10.1002/mrm.70318)). These networks can also be used to generate dictionaries of synthetic signals for simulation-informed microvascular mapping.
