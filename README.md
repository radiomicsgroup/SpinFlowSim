...
* The folder [**networks**](https://github.com/radiomicsgroup/SpinFlowSim/tree/main/networks) contains the resolved 2D vascular networks generated for our [Medical Image Analysis paper](https://doi.org/10.1016/j.media.2025.103531). These can be used to synthesise vascular dMRI signals for any acquisition protocol of interest (find [here](https://github.com/radiomicsgroup/SpinFlowSim/tree/main/networks/README.md) how).
* The folder [**networks3D**](https://github.com/radiomicsgroup/SpinFlowSim/tree/main/networks3D) contains additional 3D networks. These were generated by perturbing the original 2D networks contained in the folder [**networks**](https://github.com/radiomicsgroup/SpinFlowSim/tree/main/networks) as illustrated in our second paper (Voronova et al, Magnetic Resonance in Medicine 2026, [doi: 10.1002/mrm.70318](https://doi.org/10.1002/mrm.70318)). Again, this new set of networks can also be used to generate dictionaries of synthetic signals for simulation-informed microvascular mapping.
